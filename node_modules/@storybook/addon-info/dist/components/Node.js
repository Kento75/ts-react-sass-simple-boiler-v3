...
function getData(element) {
  ...
  data.name = (0, _reactUtils.getDisplayName)(element.type);
  return data;
}
...
function Node(props) {
  ...
  if ((0, _reactIs.isForwardRef)(node) && !node.type.displayName) {
    var childElement = node.type.render(node.props);
    return _react["default"].createElement("div", null, _react["default"].createElement("div", {
      style: containerStyleCopy
    }, _react["default"].createElement("span", {
      style: tagStyle
    }, "<", "ForwardRef"), _react["default"].createElement(_Props["default"], {
      node: node,
      ...
      style: tagStyle
    }, ">")), _react["default"].createElement(Node, {
      node: childElement,
      depth: depth + 1,
      maxPropsIntoLine: maxPropsIntoLine,
      maxPropObjectKeys: maxPropObjectKeys,
